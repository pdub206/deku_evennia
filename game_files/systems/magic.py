...
STANDARD_HANDLERS: Mapping[str, HandlerContract] = MappingProxyType(
    {
        ...
        "guiding_bolt": HandlerContract(
            "guiding_bolt",
            frozenset({"damage", "effects"}),
            frozenset({TargetingMode.HOSTILE}),
        ),
        "aid": HandlerContract(
            "aid",
...
_RELEASED_MAGIC = (
    ...
    MagicDefinition(
        key="cleric.guiding_bolt",
        display_name="Guiding Bolt",
        aliases=("guiding",),
        kind=MagicKind.SPELL,
        school="evocation",
        tags=("level_1", "offense"),
        class_access=(ClassAccess("Cleric", 1),),
        access_modes=(AccessMode.PREPARED,),
        action_category="combat",
        handler_key="guiding_bolt",
        targeting=Targeting(TargetingMode.HOSTILE, filters=("character", "living")),
        range=RangeCategory.ROOM,
        spell_level=1,
        cost=ResourceCost("cleric.spell_slot.1", 1),
        damage=Damage(DiceExpression(4, 6), "radiant"),
        duration=2,
        effect_keys=("magic.guiding_bolt",),
        player_help=PlayerHelp(
            "guiding bolt",
            "Make a spell attack for 4d6 Radiant damage; on a hit, the next attack against that foe has Advantage.",
            "Alpha adaptation: the revealing light lasts at most two six-second effect pulses and is then consumed by the next weapon or spell attack.",
        ),
        srd_reference="SRD 5.2.1 Spell Descriptions: Guiding Bolt",
    ),
    MagicDefinition(
        key="cleric.inflict_wounds",
        display_name="Inflict Wounds",
        aliases=("inflict",),
        kind=MagicKind.SPELL,
        school="necromancy",
        tags=("level_1", "offense"),
        ...
        spell_level=1,
        cost=ResourceCost("cleric.spell_slot.1", 1),
        damage=Damage(DiceExpression(3, 10), "necrotic"),
        player_help=PlayerHelp(
            "inflict wounds",
            "Make a melee spell attack against a creature you can touch for 3d10 Necrotic damage.",
            "Only level 1 casting is available in the alpha.",
        ),
        srd_reference="SRD 5.2.1 Spell Descriptions: Inflict Wounds",
    ),
    MagicDefinition(
        key="cleric.aid",
        display_name="Aid",
        ...
        kind=MagicKind.SPELL,
        school="abjuration",
        tags=("level_2", "defense", "healing", "alpha_single_target"),
        ...
        range=RangeCategory.ROOM,
        spell_level=2,
        cost=ResourceCost("cleric.spell_slot.2", 1),
        duration=4800,
        effect_keys=("magic.aid",),
        player_help=PlayerHelp(
            "aid",
            "Increase one nearby creature's maximum and current Hit Points by 5 for 4,800 six-second effect pulses.",
            "Alpha adaptation: Aid targets one creature instead of three and is available only at level 2.",
        ),
        srd_reference="SRD 5.2.1 Spell Descriptions: Aid",
    ),
    MagicDefinition(
